...
use xforge_core::security::{parse_private_key_hex, parse_public_key_hex, public_key_from_private_key, sign, verify};
use xforge_publish::github::GitHubPublisher;
use xforge_publish::release::{asset_from_path, publish_release, PublishRequest};
...
pub struct SignedAssets {
    ...
    pub signed_files: Vec<PathBuf>,
    pub assets: Vec<xforge_publish::ReleaseAsset>,
}
...
pub fn prepare_signed_assets(
    ...
    let manifest_filename = manifest_path
        ...
        .unwrap_or("xforge-manifest.json");
...
fn dedupe_assets(paths: Vec<PathBuf>) -> Result<Vec<xforge_publish::ReleaseAsset>, String> {
